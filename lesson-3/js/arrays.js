...
let orgFive = 'Toronto Maple Leafs, Chicago Black Hawks, Detroiy Red Wings, Boston Bruins, Montreal Canadians';
console.log(orgFive);
let origFiveArray = orgFive.split(', ');
console.log(origFiveArray);
// Output one of the array items
console.log(origFiveArray[2]);
...
let origSevenLength = origFiveArray.push('Network Tangers','Philadelphia Flyers');
...
origSevenLength = origFiveArray.shift('Buffalo Sabres');
output.textContent = origFiveArray;
