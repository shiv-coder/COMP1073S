...
//if homework done is null,true or any other value except false, the else block will run
//if the variable is either null or undefined,JS is loosely checking
//homeWorkDone == null //true if value is null or undefined
//homeWorkDone === null//true only if value is exactly null
...
output.textContent = `You have earned a ${breakDuration} minute break `;//template literal
